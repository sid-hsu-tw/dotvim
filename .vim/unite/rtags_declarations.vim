function! unite#sources#rtags_declarations#define() "{{{
  return s:source_rtags_declarations
endfunction "}}}

" line source. "{{{
let s:source_rtags_declarations = {
      \ 'name' : 'rtags/declarations',
...
function! s:source_rtags_declarations.hooks.on_syntax(args, context)
...
function! s:source_rtags_declarations.gather_candidates(args, context)
